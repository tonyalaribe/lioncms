...
// username or email = lion@past3.com.ng
// password = lion2018
...
func App() *buffalo.App {
	...
	app.GET("/hotels/{slug}", AccomodationHandler)
	...
	app.POST("/register", Register2Handler)
	app.GET("/book/{id}", BookAccomodationPage)
	app.POST("/book/{id}", BookAccomodation)
