...
type AccomodationListResult struct {
	Data []content.Accomodation `json:"data"`
}
...
var accomodationCache *ponzi.Cache
...
func initAccomodationCache() {
	if accomodationCache == nil {
		pageCache = ponzi.New(BaseURL, 1*time.Minute, 30*time.Second)
	}
}
